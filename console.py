...
class HBNBCommand(cmd.Cmd):
    ...
    def default(self, arg):
        """Deafult behaviour for cmd module when input is invalid"""
        action_map = {
            "all": self.do_all,
            "show": self.do_show,
    ...
    def do_quit(self,argv):
        """Whwn executed, exits the console."""
        return True
    ...
    def do_destroy(self, argv):
        """Delete a class instances based on the name and given id."""
        ...
        updating attribute and save it to the JSON file."""
         ...
         if arg_list:
            if len(arg_list) == 1:
                ...
                if intances_id in self.storage.all():
                    if len(arg_list) == 2:
