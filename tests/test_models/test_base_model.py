...
class TestBaseModel(unittest.TestCase):
   ...
   # ========== TESTS FOR CLASS ATRRIBUTES/OBJECT INSTANCES =========
    ...
    def test_set_obj(self):
        """Sets the object/instances occurance"""
        ...
        def test_my_obj-without_argument(self):
        ...
        def test_attributes(self):
            ...
            self.assertTrue(abs(t_difference.total_seconds()) < 0.001)
  ...
  # ======== THE __STR__ METHOD TESTS ==========
       ...
       def test_str_representation(self):
           ...
           # check if 'id' attributes is present.
    ...
    def test_str_method(self):
        ...
        special_char = re.sub(
            r"(datetime\.datetime\([^)]*\))", "'\\1'", special-char
        )
        # to be continued

  # ========== THE TO_DICT METHOD TESTS ==========
    def test_without_args_dict(self):
        """Tests for dictionary with no arguments(to_dict method)"""
        pass

    def test_save_method(self):
        """Test that the save method updates the 'updated_at' attributes."""
        obj = BaseModel()
        prev_updated_at = obj.updated_at
        obj.save
        self.asserNotEqual(prev_updated_at, obj.updated_at)
    ...
    def test_is_type2(self):
        """Tests type test in dictionary"""


 # ========== THE SAVE METHOD TESTS ==========

    def test_save_method(self):
        """Test that the save method 'updated_at' attributes."""
    ...
    #          erro_msg = "save() 1 postional argument but 2 were given"
    #          self.assertEqual(str(e.exception), erro_msg)

    # def test_storage_save(self):
    #     """
    #     Test for the function call of save() that it's from the stprage
    #     module.
    #     """
    #     self.resetStroage()
    #     my_obj = BaseModel()
